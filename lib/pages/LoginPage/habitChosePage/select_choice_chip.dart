...
class SelectChoiceChip extends StatefulWidget {
  ...
  const SelectChoiceChip(
      ...
      this.height = 70,
      this.padding =
          const EdgeInsets.only(left:20, top: 14, right: 20, bottom: 14),
      this.fontSize = 21,
      ...
      this.border = const Border.fromBorderSide(BorderSide(
          color: Color(0xFF535353), width: 2, style: BorderStyle.solid)),
      this.selectBorder = const Border.fromBorderSide(BorderSide(
          color: Color(0xFF1C74D0), width: 2, style: BorderStyle.solid)),
      this.onSelected,
      this.selected,
